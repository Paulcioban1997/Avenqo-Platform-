...
class AssistantStrings {
  ...
  factory AssistantStrings.fallback() => const AssistantStrings(
        ...
        unsupportedIntent: 'Avenqo cannot route this request to an available specialist yet.',
        retailNotEntitled: 'Retail Intelligence is not included in your current subscription.',
...
class CompanyStrings {
    ...
    return CompanyStrings(
      ...
      connectorHub: {
        for (final key in const [
          ...
          key: connectorHub?[key] as String? ?? fallback.connectorHub[key]!,
      },
  ...
  factory CompanyStrings.fallback() => const CompanyStrings(
    ...
    connectorHub: {
      ...
      'wooManualDescription': 'Use only when browser authorization is unavailable.',
      ...
      'wooCredentialsRequired': 'Enter both the consumer key and consumer secret.',
