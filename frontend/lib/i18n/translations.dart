...
class AuthStrings {
  ...
  factory AuthStrings.fallback() => const AuthStrings(
    ...
    emailDeliveryUnavailable:
        'Email delivery is temporarily unavailable. Contact support or try again later.',
...
class CompanyStrings {
  const CompanyStrings({
    ...
    required this.connectionsDeleteData,
    required this.connectionsDeleteSelected,
    required this.connectionsDeletePermanently,
    required this.connectionsDeleteCancel,
    required this.connectionsDeleteTitle,
    required this.connectionsDeleteWarning,
    required this.connectionsDeleteSuccess,
    required this.connectionsDeleteFailure,
    required this.connectionsUploadedSource,
    required this.connectionsSynchronizedSource,
    required this.connectionsSelectedCount,
  ...
  factory CompanyStrings.fromJson(Map<String, dynamic> json) {
    ...
    final connectorHub = json['connectorHub'] as Map<String, dynamic>?;
